...
const RULES: &[AppRule] = &[
    ...
    AppRule {
        ...
        dns_suffix: &["netflix.com", "nflxvideo.net"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        name: "Twitch",
        category: "Video",
        sni_suffix: &["twitch.tv", "twitchcdn.net"],
        dns_suffix: &["twitch.tv"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["bilibili.com", "hdslb.com"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["weixin.qq.com", "wechat.com"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["instagram.com", "cdninstagram.com"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["whatsapp.com", "whatsapp.net"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443, 5222],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["twitter.com", "x.com", "twimg.com"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["discord.com", "discordapp.com"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["teams.microsoft.com"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["github.com", "githubusercontent.com"],
        http_host_suffix: &["github.com"],
        ja3_prefix: &[],
        ports: &[443, 22],
        min_bytes: 0.0,
        is_streaming: false,
    ...
    AppRule {
        ...
        dns_suffix: &["apple.com", "icloud.com"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443, 5223],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["amazonaws.com", "cloudfront.net"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["googleapis.com", "gcr.io"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["spotify.com", "scdn.co"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["163.com", "music.163.com"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["chatgpt.com", "openai.com"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["anthropic.com", "claude.ai"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["copilot.microsoft.com"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["apple.com", "icloud.com", "appsto.re"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443, 5223],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        category: "System",
        sni_suffix: &[],
        dns_suffix: &["pool.ntp.org", "time.apple.com", "ntp.org"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[123],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        dns_suffix: &["google.com", "gstatic.com"],
        http_host_suffix: &[],
        ja3_prefix: &[],
        ports: &[443],
        min_bytes: 0.0,
    ...
    AppRule {
        ...
        name: "Baidu",
        category: "Web",
        sni_suffix: &["baidu.com", "bdstatic.com"],
    ...
    pub fn classify(
        ...
        for rule in RULES {
            ...
            if total_bytes > 0.0 {
                ...
                if rule.is_heartbeat
                    && total_bytes < HEARTBEAT_BYTES_MAX
                    && total_packets <= HEARTBEAT_PKT_MAX
                {
                    score += 0.3;
                }
            }
